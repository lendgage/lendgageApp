...
const PersonalInfo = () => {
    const [looseAddress, setLooseAddress] = useState('');
    function handleLooseAddress(e){
        setLooseAddress(e.target.value);
    }
    const cityMention = {
        options: selectCity,
    ...
    return (
        <Box sx={{padding:'4rem', width:'80%', height:'60vh'}}>
            ...
            <Typography variant="h5" sx={{color:'#38b6ff', marginBottom:0, marginTop:4, fontFamily:'Montserrat, sans-serif', fontWeight:'bold'}}>
            ...
            <Grid container spacing={2}>
                <Grid item xs={10}>
                    <TextField fullWidth id='standard-basic' label='Enter your Current Present Address' variant='standard' handleChange={handleLooseAddress}/>
                </Grid>
                <Grid item xs={5}>
                    <Autocomplete
                        {...cityMention}
